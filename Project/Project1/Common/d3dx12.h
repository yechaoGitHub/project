...
inline void GetResourceFootPrint(ID3D12Resource *resource, UINT firstSubresource, UINT numSubresources, D3D12_PLACED_SUBRESOURCE_FOOTPRINT *footPrint)
{
    ...
    pDevice->GetCopyableFootprints(&Desc, firstSubresource, numSubresources, 0, footPrint, nullptr, nullptr, nullptr);
    pDevice->Release();
}
